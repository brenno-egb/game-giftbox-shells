            ...
            <div className="w-full space-y-5">
              ...
              <button
                ...
                className={`
                  ...
                  ${!canAfford ? "opacity-90 grayscale cursor-not-allowed" : "hover:scale-[1.02] active:scale-[0.98] active:border-b-0 active:translate-y-1.5"}
                `}
                style={{
                  backgroundColor: canAfford ? theme.accent : "#555f6d",
                  borderColor: canAfford ? theme.accentBorder : "#363d45",
                  boxShadow: `0 4px 10px ${canAfford ? (theme.accentGlow === "transparent" ? "rgba(0,0,0,0.4)" : theme.accentGlow) : "rgba(0,0,0,0.4)"}`,
